...
export const UPDATE_USERS_LOADING = 'update/users/loading'
export const UPDATE_USERS_ERROR = 'update/users/error'
export const UPDATE_USERS_SUCCESS = 'update/users/success'

export const DELETE_USERS_LOADING = 'delete/users/loading'
export const DELETE_USERS_ERROR = 'delete/users/error'
...
export const ADD_PRODUCTS_LOADING = 'add/products/loading'
export const ADD_PRODUCTS_ERROR = 'add/products/error'
export const ADD_PRODUCTS_SUCCESS = 'add/products/success'

export const UPDATE_PRODUCTS_LOADING = 'update/products/loading'
